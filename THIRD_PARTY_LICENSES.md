...
### Go MELSEC example (`adapters/go/sdk/examples/melsec_mc_sensor`)

The MC protocol client is implemented in the example itself; its only
third-party dependency is `gopkg.in/yaml.v3` (MIT/Apache 2.0).
